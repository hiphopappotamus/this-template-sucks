...
$offcanvas_use_icon = $offcanvas_options_group['offcanvas_use_icon']; // true / false
...
/**
 * @var array $controls_array  Array of Bootstrap controls for offcanvas behavior  
...
<div class="offcanvas <?php echo $position_class; ?>" tabindex="-1" id="offcanvasNav" aria-labelledby="offcanvasNavLabel" <?php
    ...
    <div class="container">
        <h5 class="offcanvas-title" id="offcanvasNavLabel" style="color: <?php echo $offcanvas_custom_main_title_color; ?>;">
          <a href="<?php echo esc_url(home_url('/')); ?>" rel="home" style="font-family: inherit; color: inherit;">
            <?php echo $offcanvas_main_title; ?>
          </a>
        </h5>
